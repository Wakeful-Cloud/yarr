...
> [!CAUTION]
> This repository/image is deprecated now that upstream yarr ships a Docker image. See [this issue](https://github.com/nkanaev/yarr/issues/20#issuecomment-5492234468) for more information and [this guide](https://nkanaev.github.io/yarr/en/installation/docker/) for instructions on how to use the official Docker image.
...
_Note: for improved security and stability, you should use specific commit tags instead of `latest`._
...
| `ACKNOWLEDGE_DEPRECATION` | `false`          | Must be set to `true` to run this image, acknowledging that it is deprecated |
